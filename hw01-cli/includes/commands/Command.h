...
/// Entity for representing command. It has a name and arguments. It can be executed by command executors.
class Command {
public:
    Command() = default;
    ...
    /// Concatenates command name and command arguments string representations and returns concatenation.
