...
/// Entity for building command by appending new tokens. The first token should be LITERAL and should contains a
/// command name others tokens will be correspond to the arguments part.
class CommandBuilder {
public:

    /// Add token to the end of token sequence. If there are no any tokens yet and new token is not LITERAL or it token
    /// content is empty then such token will be skipped.
