...
/// Entity without state, the main task of which is substitution and assign operations.
class Substitutor {
public:

    /// Tries to substitute variables values instead of $name constructions using given environment.
    ...
    /// Checks, whether or not command is the substitution command If no then false will be returned
